...
@Composable
fun App(map: MutableList<MutableList<Int>>, climate: Climate, wind: Wind, location: Location) {
    Column (modifier = Modifier.padding(10.dp)){
        SimulationView(map = map, Modifier.border(border = BorderStroke(2.dp, Color.Black)).padding(10.dp).fillMaxWidth().fillMaxHeight(1/2f))
